...
| [Filament Sufficiency Warnings & Pushover Notifications](filament-warnings.md) | Mid-print spool shortage detection, warning severity levels, Pushover push notifications, and optional auto-pause (PrusaLink only) |
